...
% PSPanel = uipanel(ParameterSelection,'Title',InfoCell{i,1},'FontSize',7,'Units','pixels','Position',[10 10 100 200],'BackgroundColor','w','fontweight','bold');
% listBoxP = uicontrol(Gp(i),'Style','listbox','Units','pixels',...
%             'Position',[1 1 70 180],...
