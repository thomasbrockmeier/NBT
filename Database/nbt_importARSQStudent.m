...
rsq.Answers(59,1) = nanmean(double(tmpQ([1,11,21])));
rsq.Answers(60,1) = nanmean(double(tmpQ([2,12,22])));
rsq.Answers(61,1) = nanmean(double(tmpQ([3,13,23])));
rsq.Answers(62,1) = nanmean(double(tmpQ([4,14,24])));
rsq.Answers(63,1) = nanmean(double(tmpQ([5,15,25])));
rsq.Answers(64,1) = nanmean(double(tmpQ([6,16,26])));
rsq.Answers(65,1) = nanmean(double(tmpQ([7,17,27])));
rsq.Answers(66,1) = nanmean(double(tmpQ([10,20,30])));
rsq.Answers(67,1) = nanmean(double(tmpQ([8,18,28])));
rsq.Answers(68,1) = nanmean(double(tmpQ([9,19,29])));
