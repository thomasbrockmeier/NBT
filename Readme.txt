...
The NBT toolbox comes with functions from BioSig: Copyright (C) by Alois Schloegl

The NBT toolbox comes with functions from ERP-PCA toolkit Copyright (C) 1999-2010 Joseph Dien

The NBT toolbox comes with functions from the FASTER toolbox Copyright (C) 2010 Hugh Nolan, Robert Whelan and Richard Reilly, Trinity College Dublin, Ireland

The NBT toolbox comes with functions from Fieldtrip:
...
Copyright (C) 2003-2008, F.C. Donders Centre, University Nijmegen, The Netherlands (FCDC)
